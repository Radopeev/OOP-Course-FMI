...
Реализирайте структ **Time** за работа с време. структът трябва да има три член-данни:

* час (int)
* минути (int)
* секунди (int)

структът трябва да предоставя следните **функционалности**:
...
структ **Train**
структът представлява влак в метрото и съдържа следните член-данни:
...
структ **Underground**
структът представлява цялата мрежа на метрото и съдържа следните член-данни:
